    ...
    <v-footer absolute color="transparent">
        ...
        <div class="text-center">
            ...
            >
                ...
                <v-btn class="mx-2" fab small dark medium color="yellow darken-2" @click="onFastSpinButtonClick">
                    <v-icon dark>{{ !fastSpin ? "mdi-flash": "mdi-flash-off"}}</v-icon>
                </v-btn>

                <v-dialog v-model="autoSpinsDialog" max-width="290">
                    <template v-slot:activator="{ on }">
                        <v-btn v-on="on" v-show="!autoSpinning" class="mx-2" fab small dark medium color="yellow darken-2">
                    ...
                    <v-card>
                        ...
                        <v-card-actions center>
                            <v-spacer></v-spacer>
                            <v-btn color="blue darken-1" text @click="onAutoSpinButtonClick">Play</v-btn>
                            <v-spacer></v-spacer>
                        </v-card-actions>
                    </v-card>
                </v-dialog>
